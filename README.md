...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/silent-sunset-d060)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/silent-sunset-d060
```

A live public deployment of this template is available at [https://silent-sunset-d060.templates.workers.dev](https://silent-sunset-d060.templates.workers.dev)
